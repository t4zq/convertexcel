...
export const privacyPolicy: Record<Language, PrivacyPolicyContent> = {
  ...
  ko: {
    notice:
      "converTeXcel은 무료이며 광고가 없고 계정이 필요 없는 변환 도구입니다. 변환은 주로 브라우저 내에서 이루어지며, 본 서비스는 개인정보 수집을 목적으로 하지 않습니다. 이 페이지는 투명성 안내 요약입니다.",
    sections: [
      {
        title: "기본 방침",
        bullets: [
          "변환 처리는 주로 브라우저 내 Rust/WebAssembly에서 수행됩니다.",
          "그래프(gnuplot) 미리보기도 브라우저 내에서 렌더링되며 외부로 전송되지 않습니다.",
          "PDF 미리보기를 실행하는 경우에만 동의 후 생성된 코드와 필요한 데이터를 texlive.net으로 전송합니다.",
          "광고 추적, 행동 타겟팅, 데이터 판매를 하지 않습니다.",
          "이름, 이메일 주소, 계정 등록이 필요하지 않습니다.",
        ],
      },
      {
        title: "데이터 처리와 이용자의 권리",
        paragraphs: [
          "입력 내용은 기본적으로 브라우저 내에 머뭅니다. localStorage에 저장된 입력과 설정은 브라우저 설정에서 언제든지 삭제할 수 있습니다.",
          "공유 링크는 입력 내용을 URL 자체에 포함하므로 공유 대상 관리에 유의하세요.",
        ],
      },
      {
        title: "문의 및 문제 신고",
        paragraphs: [
          `질문, 버그 신고, 개인정보 관련 의견은 GitHub issue로 문의해 주세요: ${ISSUES_URL}`,
        ],
      },
    ],
    dataTable: {
      title: "처리하는 데이터, 목적, 보유 기간",
      headers: {
        category: "데이터 카테고리",
        purpose: "목적",
        legalBasis: "법적 근거",
      ...
      rows: [
        {
          category: "붙여넣은 표 데이터, 생성된 LaTeX/CSV/TikZ/gnuplot 코드",
          purpose: "변환 결과 생성·편집·미리보기",
          legalBasis: "이용자의 조작 및 요청에 대한 대응",
          retention: "일반적으로 브라우저 내에만 존재하며, localStorage에 저장된 경우 이용자가 삭제할 때까지.",
        },
        {
          category: "localStorage의 입력 내용 및 표시 설정",
          purpose: "입력 복원, 설정 유지",
          legalBasis: "이용자의 선택",
          retention: "이용자가 브라우저에서 삭제하거나 앱이 덮어쓸 때까지.",
        },
        {
          category: "IP 주소, User-Agent, 요청 로그 등 기술 데이터",
          purpose: "전송, 보안, 장애 조사",
          legalBasis: "정당한 이익 또는 법적 의무",
          retention: "호스팅/CDN 제공자의 로그 보존 설정에 따릅니다.",
        },
      ],
    },
    thirdParties: {
      title: "제3자 및 국외 이전",
      intro: "본 서비스는 다음 외부 서비스를 사용할 수 있습니다.",
      rows: [
        {
          service: "texlive.net",
          purpose: "PDF 미리보기 생성",
          data: "표/그래프 코드, 그래프용 CSV, 컴파일에 필요한 데이터",
          timing: "확인 대화상자에서 동의한 후",
        },
        {
          service: "Cloudflare Pages/Workers 또는 동등한 호스팅/CDN",
          purpose: "사이트 전송, TLS, 보안, 로그",
          data: "IP 주소, User-Agent, 요청 메타데이터 등",
          timing: "사이트 접속 시",
        },
      ],
    },
    regional: {
      title: "지역별 보충",
      items: [
        "적용 법률에 따라 접근, 정정, 삭제, 처리 제한, 이의 제기 등의 권리가 인정될 수 있습니다. 권리 행사나 우려 사항은 GitHub issue로 문의해 주세요.",
      ],
    },
  },
  es: {
