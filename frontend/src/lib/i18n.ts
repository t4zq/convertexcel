...
export const seo = {
  ja: {
    ...
    privacyDescription:
      "converTeXcelの入力データ、共有リンク、PDFプレビュー、Google Analytics、Google AdSense、gnuplotのブラウザ内描画について説明します。",
    features: [
  ...
  en: {
    ...
    privacyDescription:
      "Learn how converTeXcel handles input data, share links, PDF preview services, Google Analytics, Google AdSense, and in-browser gnuplot rendering.",
    features: [
  ...
  zh: {
    ...
    privacyDescription:
      "了解 converTeXcel 如何处理输入数据、共享链接、PDF 预览服务、Google Analytics、Google AdSense，以及 gnuplot 的浏览器内渲染。",
    features: [
  ...
  "zh-Hant": {
    ...
    privacyDescription:
      "了解 converTeXcel 如何處理輸入資料、分享連結、PDF 預覽服務、Google Analytics、Google AdSense，以及 gnuplot 的瀏覽器內算繪。",
    features: [
  ...
  es: {
    ...
    privacyDescription:
      "Conoce cómo converTeXcel gestiona los datos de entrada, enlaces compartidos, servicios de vista previa PDF, Google Analytics, Google AdSense y el renderizado de gnuplot en el navegador.",
    features: [
  ...
  de: {
    ...
    privacyDescription:
      "Erfahre, wie converTeXcel Eingabedaten, Freigabelinks, PDF-Vorschaudienste, Google Analytics, Google AdSense und das gnuplot-Rendering im Browser behandelt.",
    features: [
